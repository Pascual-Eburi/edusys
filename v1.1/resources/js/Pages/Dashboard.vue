                            ...
                            <ul class="list-none crm-top-deals mb-0">
                                ...
                                <div class="flex items-start flex-wrap">
                                    ...
                                    <span class=" inline-flex items-center justify-center">
                                        <img src="src/assets/images/faces/10.jpg" alt=""
                                ...
                                <div class="flex items-top flex-wrap">
                                    <div class="me-2">
                                    <span class="inline-flex items-center justify-center">
                                        <img src="src/assets/images/faces/12.jpg" alt=""
                                        class="!w-[1.75rem] !h-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-full">
                                    </span>
                                    </div>
                                    <div class="flex-grow">
                            ...
                            <table class="table min-w-full whitespace-nowrap table-hover border table-bordered">
                                ...
                                <tr class="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                    ...
                                    <div class="flex items-center font-semibold">
                                        ...
                                        <img src="src/assets/images/faces/4.jpg" alt="img"
                                            class="w-[1.75rem] h-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-full">
                                        </span>Mayor Kelly
                                    </div>
                                    </td>
                                ...
                                <tr class="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                    ...
                                    <div class="flex items-center font-semibold">
                                        ...
                                        <img src="src/assets/images/faces/15.jpg" alt="img"
                                            class="w-[1.75rem] h-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-full">
                                ...
                                <tr class="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                    ...
                                    <div class="flex items-center font-semibold">
                                        <span class="inline-flex  justify-center items-center me-2">
                                        <img src="src/assets/images/faces/11.jpg" alt="img"
                                            class="w-[1.75rem] h-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-full">
                                        </span>Simon Cowel
                                    </div>
                                    </td>
                                ...
                                <tr class="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                    ...
                                    <div class="flex items-center font-semibold">
                                        <span class="inline-flex justify-center items-center me-2">
                                        <img src="src/assets/images/faces/8.jpg" alt="img"
                                            class="w-[1.75rem] h-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-full">
                                        </span>Mirinda Hers
                                    </div>
                                    </td>
                                ...
                                <tr class="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                                    ...
                                    <div class="flex items-center font-semibold">
                                        <span class="inline-flex  justify-center items-center me-2">
                                        <img src="src/assets/images/faces/9.jpg" alt="img"
                                            class="w-[1.75rem] h-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-full">
                                        </span>Jacob Smith
                                    </div>
                                    </td>
